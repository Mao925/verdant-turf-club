...
try{
 ...
 const result=spawnSync('npx',['playwright','test','e2e/live.spec.ts'],{stdio:'inherit',env:{...process.env,P2_LIVE_URL:url,P2_LIVE_KEY:process.env.VITE_SUPABASE_PUBLISHABLE_KEY,P2_LIVE_SESSION:JSON.stringify(verified.data.session)}});
